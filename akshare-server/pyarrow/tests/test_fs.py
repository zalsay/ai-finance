...
def test_s3_options(pickle_module):
    ...
    fs = S3FileSystem(access_key='access', ***REMOVED***,
    ...
    with pytest.raises(ValueError):
        S3FileSystem(***REMOVED***, session_token='token')
    with pytest.raises(ValueError):
        S3FileSystem(
            access_key='access', ***REMOVED***, role_arn='arn'
        )
    with pytest.raises(ValueError):
        S3FileSystem(
            access_key='access', ***REMOVED***, anonymous=True
        )
    with pytest.raises(ValueError):
