...
class Config:
    ...
    def __init__(self):
        ...
        self.kronos_dir = os.path.dirname(self.current_dir)
        self.qlib_data_path = os.path.join(self.current_dir, "qlib_data/cn_data")
        self.instrument = ['SH600000', 'SH600009', 'SH600010', 'SH600015', 'SH600016']  # 使用少量股票进行测试
        ...
        self.backtest_time_range = ["2020-06-01", "2020-06-30"]

        # TODO: Directory to save the processed, pickled datasets.
        self.dataset_path = os.path.join(self.current_dir, "qlib/processed_datasets")
        ...
        self.save_path = os.path.join(self.current_dir, "outputs/models")
        instrument_str = '_'.join(self.instrument) if isinstance(self.instrument, list) else self.instrument
        self.tokenizer_save_folder_name = 'finetune_tokenizer_' + instrument_str
        self.predictor_save_folder_name = 'finetune_predictor_' + instrument_str
        self.backtest_save_folder_name = 'finetune_backtest_' + instrument_str

        # Path for backtesting results.
        self.backtest_result_path = os.path.join(self.current_dir, "outputs/backtest_results")
        ...
        self.pretrained_tokenizer_path = os.path.join(self.kronos_dir, "Kronos-Tokenizer-base")
        self.pretrained_predictor_path = os.path.join(self.kronos_dir, "Kronos-base")
    ...
    def _set_benchmark(self, instrument):
        ...
        # 如果instrument是列表，使用默认基准
        if isinstance(instrument, list):
            return "SH000300"  # 默认使用沪深300作为基准
        elif instrument in dt_benchmark:
